...
alias alias-edit='vim $dotfiles/aliases.zsh'
alias alias-reload='source $dotfiles/aliases.zsh'
...
# Dotfiles (chezmoi)
alias dotfiles-apply='chezmoi apply'
alias dotfiles-update='chezmoi update'
alias dotfiles-edit='chezmoi edit'
alias dotfiles-diff='chezmoi diff'
alias dotfiles-status='chezmoi status'

# Remote Development (Azure VM)
alias remote-start='az vm start -g rg-remote-development -n ubuntu-remote-dev'
...
alias remote-ssh='ssh ubuntu-remote-dev'
